...
// Initialize form permission variables for fresh installations - PUT THIS HERE
if (!isset($trainer_forms_selected_read_str)) {
    $trainer_forms_selected_read_str = "'Note_n','3_3','3_4','3_8','3_7','5_5','1_1','1_2','4_6'";
}
if (!isset($trainer_forms_selected_write_str)) {
    $trainer_forms_selected_write_str = "'3_3','3_4','3_8','3_7','5_5','1_1','1_2','4_6'";
}
if (!isset($trainer_view)) {
    $trainer_view = false;
}
if (!isset($trainer_view_id)) {
    $trainer_view_id = false;
}

// Now this check will work without warnings
